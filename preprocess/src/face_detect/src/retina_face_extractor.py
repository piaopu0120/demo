...
class RetinaFaceExtract():
    def __init__(self, cfg, gpu_id):
        ...
        self.net = load_model(self.net, self.cfg['weights_path'], load_to_cpu)
        self.net.eval()
    ...
    def draw(self, img, bbox, landmarks, save_path):
        bbox = bbox.astype(np.int32)
        cv2.rectangle(img, (bbox[0], bbox[1]), (bbox[2], bbox[3]), color=(255, 33, 122))
